...
<body>
    ...
    <button type="button" onclick="location.href='departamentos.php'" class="user-button">
        ...
        <button class="back-button" onclick="location.href='departamentos.php'">
            ...
            <br>
            <br>
        <h1 class="department-title">Adquisición de Talentos</h1>
            ...
            <div class="button-container">
                ...
                <button onclick="location.href='vacantes.php'">
                        ...
                        <br>
                        <div>Vacantes Disponibles</div>
                    </button>

          
                    <?php if ($user['position'] == 'A'||$user['position'] == 'X') : ?>

                     <button onclick="location.href='registro_recomendados.php'">
                        <i class="fa-solid fa-user-check icon-large"></i>
                             <br>
                             <div>Registro de recomendados</div>
                        </button>
                    <?php endif?>
                    <button onclick="location.href='guias_TA.php'">
                    <i class="fas fa-file-alt icon-large"></i>
                        <br>
                        <div>Guias de apoyo</div>
                    </button>
                    ...
                    <i class="fas fa-user-plus icon-large"></i>
                        <br>
                        <div>Agregar Nuevo personal</div>
                    </button>
                    <?php endif?>
