...
<body>
    ...
    <button type="button" onclick="location.href='departamentos.php'" class="user-button">
        ...
        <button class="back-button" onclick="location.href='departamentos.php'">
            ...
            <br>
            <br>
        <h1 class="department-title">Laborales</h1>

            <div class="button-container">

                <div class="button-grid">
                <?php if ($user['position'] !== 'D') : ?>
                ...
                <?php endif; ?>
                <?php if ($user['position'] == 'AB') : ?>
                    <button onclick="location.href='suplentes.php'">
                        <i class="fas fa-user-clock icon-large"></i>
                        <br>
                        <div>Suplentes</div>
                    </button>
                <?php endif; ?>
                <button onclick="location.href='gafetes.php'">
                        <i class="fas fa-id-badge icon-large"></i>
                        <br>
                        <div>Reposición de gafetes</div>
                    </button>
                    <button onclick="location.href='sodexo.php'">
                        <i class="fas fa-credit-card icon-large"></i>
                        <br>
                        <div>Reposición de Sodexo</div>
                    </button>
                </div>
