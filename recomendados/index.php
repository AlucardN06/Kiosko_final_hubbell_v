    ...
    <div class="form-container">
        <form id="appointmentForm" action="Consulta.php" method="POST">
            ...
            <div id="documentos" class="form-group">
                ...
                <h5><label for="documento9">En caso de aplicar a un puesto de Almacenista o Calidad:</label><br></h5>
                <label for="documento9">*DC3 (No mayor a 3 años)</label><br>
            </div>
            <button type="submit" id="scheduleButton" >Agendar Cita</button>
        </form>
        <br><br>
        <button id="adminButton" onclick="window.location.href='admin_login.php';">Administradores</button>
    </div>
