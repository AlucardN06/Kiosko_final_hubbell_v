...
if (isset($_POST['add_option']) && !isset($_SESSION['form_processed'])) {
    ...
    $query = "INSERT INTO votacion_opciones (nombre, imagen) VALUES ('$nombre', '$imagen')";
    mysqli_query($conn, $query);

    $_SESSION['form_processed'] = true;
    header("Location: admin_votacion.php");
    exit;
}
...
if (isset($_POST['update_option']) && !isset($_SESSION['form_processed'])) {
    ...
    $query = "UPDATE votacion_opciones SET nombre = '$nombre', imagen = '$imagen' WHERE id = $id";
    mysqli_query($conn, $query);
...
if (isset($_POST['delete_option']) && !isset($_SESSION['form_processed'])) {
    $id = intval($_POST['id']);
    $query = "DELETE FROM votacion_opciones WHERE id = $id";
    mysqli_query($conn, $query);
...
// Borrar toda la información de las tablas votacion_opciones y votos
if (isset($_POST['delete_all']) && !isset($_SESSION['form_processed'])) {
    $query_delete_votos = "DELETE FROM votos";
    mysqli_query($conn, $query_delete_votos);
    $query_delete_opciones = "DELETE FROM votacion_opciones";
...
<body>
    <div class="container">
        ...
        <div class="middle-section">
            ...
            <form action="admin_votacion.php" method="POST" enctype="multipart/form-data">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <form action="admin_votacion.php" method="POST" enctype="multipart/form-data" style="display:inline-block;">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                            <input type="text" name="nombre" value="<?php echo $row['nombre']; ?>" required>
                            <input type="file" name="imagen" required>
                            <button type="submit" name="update_option">Modificar</button>
                        </form>
                        <form action="admin_votacion.php" method="POST" style="display:inline-block;">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
            ...
            <form action="admin_votacion.php" method="POST">
