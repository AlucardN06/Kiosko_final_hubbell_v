...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2024 at 04:19 PM
...
INSERT INTO `extravios` (`id`, `numero_reloj`, `nombre`, `fecha_hora`, `costo`, `pendiente`) VALUES
(4, '118849', ' Diana Laura Berdeja Carrillo', '2024-08-15 18:37:32', 40.00, 1);
...
--
-- Dumping data for table `votacion_opciones_nuevo`
--

INSERT INTO `votacion_opciones_nuevo` (`id`, `nombre`, `imagen`, `anio`) VALUES
(8, 'Set de Sartenes Tramotina de 9 piezas + Licuadora de 10 velocidades', 'uploads/5.1.PNG', 5),
(9, 'Magic Bullet + Sandwichera + Set de 8 vasos de vidrio', 'uploads/5.2.PNG', 5),
(10, 'Olla Presión + Vajilla de 12 pz + Set de utensilios de cocina', 'uploads/5.3.PNG', 5),
(11, 'Tableta de 7\" 32 GB + Smart Watch', 'uploads/10.1.PNG', 10),
(12, 'Batería de cocina de 10 piezas + Bocina con subwoofer de 6\" con microfono y control remoto + licuadora de 10 velocidades ', 'uploads/10.2.PNG', 10),
(13, 'Olla Presión + Set de Sartenes tramotina de 9 piezas + vajilla de porcelana de 12 piezas', 'uploads/10.3.PNG', 10),
(14, 'Faberware 1.5L 20 Bar Espresso Maker + Cafe starbucks 18oz + Set de 2 tazas doble pared vidrio', 'uploads/15.1.PNG', 15),
(15, 'Ninja 4QT Air Fryer + Vajilla de 12 piezas', 'uploads/15.2.PNG', 15),
(16, 'Asador p/ Carbón de 17.5\" + Hielera de 48qt + Bocina con subwoofer de 6\"', 'uploads/15.3.PNG', 15),
(17, '0.9 cu.ft Microwave Oven + Set de sartenes Faberware de 12 piezas', 'uploads/20.1.PNG', 20),
(18, 'Tramontina Primaware 18-piece Nonstick Cookware Set + Set Contenedores + Vajilla 12 piezas + Horno Tostador + Set Vasos 8 piezas + Arrocera de  tazas', 'uploads/20.2.PNG', 20);
