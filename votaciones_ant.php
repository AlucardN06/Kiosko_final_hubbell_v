...
<body>
    ...
    <button type="button" onclick="location.href='departamentos.php'" class="user-button">
        ...
        <button class="back-button" onclick="location.href='departamentos.php'">
            ...
            <br>
            <br>
        <h1 class="department-title">Regalos por antigüedad</h1>
...
<button onclick="location.href='admin_votacion_ant.php'">
   <i class="fas fa-poll icon-large"></i>
        <br>
        <div>Administrador de votaciones</div>
   </button>
<?php endif?>


<button onclick="location.href='votacion_ant.php'">
    <i class="fas fa-gift icon-large"></i>
    <br>
    <div>Votación para regalos</div>
</button>
