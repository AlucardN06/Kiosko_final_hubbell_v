...
<body>
    ...
    <button type="button" onclick="location.href='departamentos.php'" class="user-button">
        ...
        <button class="back-button" onclick="location.href='departamentos.php'">
            ...
            <br>
            <br>
        <h1 class="department-title">Comunicaciones</h1>
            ...
            <div class="button-container">
                ...
                <button onclick="location.href='eventos.php'">
                        <i class="bi-balloon icon-large"></i>
                        <br>
                        <div>Comunicaciones Hubbell</div>
                    </button>
                    <?php if ($user['position'] == 'A' || $votacion_enabled) : ?>
                    <button onclick="location.href='votacion.php'">
                        <i class="fas fa-vote-yea icon-large"></i>
                        <br>
                        <div>Votación</div>
                    </button>
                <?php endif; ?>
